...
using plgm_DebugConsole.EasyConsole.Homens;
using UnityEngine;
...
public class Console : MonoBehaviour
{
    ...
    [SerializeField] private int linesOfHistory = 1000;

    public int maxLineWidth = 80;

    private CircularBuffer<string> commands;

    [SerializeField] private int commandHistory = 100;

    private Dictionary<string, global::Console.DirectCommand> directCommands =
        new Dictionary<string, global::Console.DirectCommand>();

    [SerializeField] private bool printDebug = true;

    private Dictionary<Type, global::Console.ParserCallback> parsers =
        new Dictionary<Type, global::Console.ParserCallback>();

    private Component selectedComponent = null;

    public static global::Console Instance
    {
        get { return global::Console.instance; }
    }
    ...
    public static void parseCommand(string line, out string command, out string[] gameobjectPath,
        out string componentName, out string methodName, out string[] parameters)
    {
        if (line == null || line == "")
        {
            command = "";
    ...
    public static void parseGameObjectString(string line, out string[] gameobjectPath, out string componentName,
    ...
    private void Help(params string[] arg)
    {
        if (arg.Length > 0)
        {
            ...
            {
                HelpAttribute[] array =
                    directCommand.method.GetCustomAttributes(typeof(HelpAttribute), true) as HelpAttribute[];
