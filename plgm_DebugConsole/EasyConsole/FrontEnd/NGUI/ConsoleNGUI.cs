...
class ConsoleNGUI : MonoBehaviour
{
    public UIRoot root = new GameObject().AddComponent<UIRoot>();
    public UILabel logLabel = new GameObject().AddComponent<UILabel>();
    public UIScrollBar logScroll = new GameObject().AddComponent<UIScrollBar>();
    public UIInput commandInput = new GameObject().AddComponent<UIInput>();
    public UIPanel objectComponentPanel = new GameObject().AddComponent<UIPanel>();
    public UIPanel methodPanel = new GameObject().AddComponent<UIPanel>();
    public UIScrollBar methodPanelScroll = new GameObject().AddComponent<UIScrollBar>();
    ...
    void OnMethodButtonClick(GameObject go)
    {
        int firstDot = command.IndexOf('.');
    ...
    void OnComponentButtonClick(GameObject go)
    {
        int firstDot = command.IndexOf('.');
    ...
    void OnObjectButtonClick(GameObject go)
    {
